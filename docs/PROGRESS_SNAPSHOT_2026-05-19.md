...
| **8** | HR 細節補強 | 🟡 進行中 | **4/5** | 8.1 / 8.2 / 8.3 / 8.4 ✅ ／ 8.5 待 |
| **9** | 資安強化 | ✅ 完成 | **4/4** | 9.1 / 9.2 / 9.3 / 9.4 全綠 |

**已完成：** Phase 1–5 + Phase 9 + 部分 6/7/8（共 **40 個子項**）
**剩餘規劃中：** 6 個子項（Phase 6×3 / Phase 7×2 / Phase 8×1）
...
| 編號 | 名稱 | 工單檔 | 預估工期 |
|------|------|--------|---------|
| 8.5 | 員工自助申請流程（特休 / 留停） | `PHASE_8.5_EMPLOYEE_SELF_SERVICE.md` | 1~1.5 天 |
